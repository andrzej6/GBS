$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://getbritainstanding.org/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://getbritainstanding.org/api/category/read.php", function(data){
...
// chage page title
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://getbritainstanding.org/api/product/update.php",
            type : "POST",
